...
if (isset($_GET['pat_id'])) {
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'discharge') {
        $discharge_query = "UPDATE his_patients SET pat_discharge_status = 'Discharged' WHERE pat_id = ?";
    ...
    elseif (isset($_GET['action']) && $_GET['action'] == 'return') {
        ...
        $return_query = "UPDATE his_patients SET pat_discharge_status = 'Returned' WHERE pat_id = ?";
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $ret = "SELECT * FROM his_patients WHERE pat_doc_id = ?"; 
