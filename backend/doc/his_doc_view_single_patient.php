                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="aboutme">
                                        <ul class="list-unstyled timeline-sm">
                                            <?php
                                            $pres_ret = "SELECT * FROM his_prescriptions WHERE pres_pat_number = ?";
                                    ...
                                    <div class="tab-pane show " id="timeline">
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                ...
                                                <?php
                                                $vit_ret = "SELECT * FROM his_vitals WHERE vit_pat_number = ?";
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <ul class="list-unstyled timeline-sm">
                                            <?php
                                            $lab_ret = "SELECT * FROM his_laboratory WHERE lab_pat_number = ?";
