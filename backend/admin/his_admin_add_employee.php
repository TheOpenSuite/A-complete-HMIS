...
if (isset($_POST['add_employee'])) {
    ...
    if ($doc_dept == 'Reception') {
        // Insert into the `his_receptionists` table if the department is "Reception"
        $insert_receptionist_query = "INSERT INTO his_receptionists (receptionist_fname, receptionist_lname, receptionist_email, receptionist_pwd) 
                                      VALUES (?, ?, ?, ?)";
...
if (isset($_POST['add_dept'])) {
    ...
    if (!empty($new_dept)) {
        ...
        $insert_dept_query = "INSERT INTO his_departments (dept_name) VALUES (?)";
